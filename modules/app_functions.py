...
class AppFunctions(MainWindow):
    def setThemeHack(self):
        ...
        # SET MANUAL STYLES
        self.ui.lineEdit.setStyleSheet("background-color: #F2F2F2;")
        self.ui.pushButton.setStyleSheet("background-color: #F2F2F2;")
        self.ui.plainTextEdit.setStyleSheet("background-color: #F2F2F2;")
        ...
        self.ui.comboBox.setStyleSheet("background-color: #F2F2F2;")
